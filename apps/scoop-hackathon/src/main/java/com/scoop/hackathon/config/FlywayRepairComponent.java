...
/**
 * Component that repairs failed Flyway migrations before Flyway initializes.
 * This implements InitializingBean to ensure it runs as early as possible.
 */
@Component
@Order(1)
public class FlywayRepairComponent implements InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(FlywayRepairComponent.class);

    @Nullable
    private final DataSource dataSource;

    public FlywayRepairComponent(@Nullable DataSource dataSource) {
